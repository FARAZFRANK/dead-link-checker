...
class BLC_Scanner
{
    ...
    private function discover_links()
    {
        ...
        // - Menu scanning (Pro)
        // - Widget scanning (Pro)
        // - Comment scanning (Pro)
        // - Custom field/ACF scanning (Pro)
    ...
    {
        $count = 0;
        // phpcs:ignore Generic.PHP.ForbiddenFunctions.Found -- This is a valid WP function needed for widget scanning
